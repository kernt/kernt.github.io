...
- [Prepare Workstation machine](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#0-prepare-workstation-machine)
- [Install Kubernetes with RKE](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#1-install-kubernetes-with-rke)
    - [RKE Supported operating systems](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#2-rke-supported-operating-systems)
    - [Update your Linux System](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#3-update-your-linux-system)
    - [Create rke user](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#4-create-rke-user)
        - [Using Ansible Playbook:](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#5-using-ansible-playbook)
        - [Create user manually on all hosts](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#6-create-user-manually-on-all-hosts)
    - [Enable required Kernel modules:](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#7-enable-required-kernel-modules)
        - [Using Ansible:](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#8-using-ansible-)
        - [The manual way](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#9-the-manual-way-)
    - [Disable swap and Modify sysctl entries](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#10-disable-swap-and-modify-sysctl-entries)
        - [Manually](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#11-manually)
    - [Install Supported version of Docker](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#12-install-supported-version-of-docker)
        - [Step 6: Open Ports on firewall](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#13-step-6-open-ports-on-firewall)
    - [Allow SSH TCP Forwarding](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#14-allow-ssh-tcp-forwarding)
    - [Generate RKE cluster configuration file](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#15-generate-rke-cluster-configuration-file)
    - [Deploy Kubernetes Cluster with RKE](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#16-deploy-kubernetes-cluster-with-rke)
- [Accessing your Kubernetes cluster](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#17-accessing-your-kubernetes-cluster)
- [Install Kubernetes Dashboard](https://computingforgeeks.com/install-kubernetes-production-cluster-using-rancher-rke/#18-install-kubernetes-dashboard)
...
**You can also create users manually on each host. Login to each of your cluster nodes and create _rke_ user.**
