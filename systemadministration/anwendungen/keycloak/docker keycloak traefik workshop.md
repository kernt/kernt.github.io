...
[docker-keycloak-traefik-workshop](https://github.com/ibuetler/docker-keycloak-traefik-workshop#docker-keycloak-idp-and-traefik-workshop)

## Introduction

[docker-keycloak-traefik](https://github.com/ibuetler/docker-keycloak-traefik-workshop#introduction)
...
## Sample Docker Application that comes _without_ Authentication

[docker-keycloak](https://github.com/ibuetler/docker-keycloak-traefik-workshop#sample-docker-application-that-comes-without-authentication)

For the sake of this tutorial I have chosen the ttyd Docker image we want to add authentication using Keycloak. The ttyd application provides web access `bash` to a kali linux machine. The ttyd sample application is not asking for a username and password. You can grab the ttyd docker source from GitHub [https://github.com/ibuetler/e1pub/tree/master/docker/hl-kali-docker-ttyd](https://github.com/ibuetler/e1pub/tree/master/docker/hl-kali-docker-ttyd) or pull the image from Docker Hub. I will pull and run the docker image below, as this tutorial is not about "how to create docker images/". The ttyd web port is listening on port `7681`.
...
[![ttyd1](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/ttyd1.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/ttyd1.png)

Please give it a try! I am doing this demo using the latest Hacking-Lab LiveCD from [https://livecd.hacking-lab.com/](https://livecd.hacking-lab.com/), as the LiveCD has docker and everything already configured and works like a charm. If you want to use the Hacking-Lab LiveCD too, please follow the following installation instructions

[https://github.com/ibuetler/e1pub/tree/master/hacking-lab-livecd-installation](https://github.com/ibuetler/e1pub/tree/master/hacking-lab-livecd-installation)
...
[traefik-load-balancing-service](https://github.com/ibuetler/docker-keycloak-traefik-workshop#traefik-load-balancing-service)

I run all my docker services `behind` traefik ([https://traefik.io/](https://traefik.io/)). I do not want to have my (hundreds of) docker services, APIs, RESTful APIs and more directly accessible from the Internet (security). I do not want to create and handle SSL/TLS certificates for every single docker services. In production; I am using an SSL wildcard certificate or Let's Encrypt TLS and point it to the traefik ip address. In development; Traefik is automatically creating self-signed certificates for me. This is what we want in this tutorial. Needless to say, Traefik is a docker service too.

[![traefik](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/traefik.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/traefik.png)
...
[pull-workshop-github-repository](https://github.com/ibuetler/docker-keycloak-traefik-workshop#pull-workshop-github-repository)
...
[create-docker-transit-networks](https://github.com/ibuetler/docker-keycloak-traefik-workshop#step-1-create-docker-transit-networks)
...
[![transit](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/transit.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/transit.png)
...
[step-2-run-traefik](https://github.com/ibuetler/docker-keycloak-traefik-workshop#step-2-run-traefik)
...
[![dockerlog](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/dockerlog.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/dockerlog.png)

### Step 3: Run ttyd together with Traefik

[step-3-run-ttyd-together-with-traefik](https://github.com/ibuetler/docker-keycloak-traefik-workshop#step-3-run-ttyd-together-with-traefik)
...
[step-4-add-three-hosts-into-etchosts](https://github.com/ibuetler/docker-keycloak-traefik-workshop#step-4-add-three-hosts-into-etchosts)
...
[step-5-testing-ttyd-via-traefik](https://github.com/ibuetler/docker-keycloak-traefik-workshop#step-5-testing-ttyd-via-traefik)
...
[![prereq](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/prereq.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/prereq.png)
Ok, then let's see how it works using the browser.

Please open Firefox and point your browser to [https://ttyd.idocker.hacking-lab.com](https://ttyd.idocker.hacking-lab.com)

[![tls](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/tls.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/tls.png)
...
[![ttyd2](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/ttyd2.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/ttyd2.png)
## Conclusion Step 1-5

[conclusion-step-1-5](https://github.com/ibuetler/docker-keycloak-traefik-workshop#conclusion-step-1-5)
...
[![lion](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/lion.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/lion.png)

## Keycloak Setup

[keycloak-setup](https://github.com/ibuetler/docker-keycloak-traefik-workshop#keycloak-setup)
...
[![keycloakpull](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/keycloakpull.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/keycloakpull.png)
...
- [https://auth.idocker.hacking-lab.com/](https://auth.idocker.hacking-lab.com/)

Traefik is issuing another self-signed TLS certificate.

[![ktls](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/ktls.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/ktls.png)

Please proceed again and you should see the IdP login prompt.

[![keycloakauth](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/keycloakauth.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/keycloakauth.png)
...
[![keycloaklogin](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/keycloaklogin.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/keycloaklogin.png)

And voilà, your keycloak IdP should be up and working.

[![keycloakok](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/keycloakok.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/keycloakok.png)

## Conclusion "Keycloak Setup"

[conclusion-keycloak-setup](https://github.com/ibuetler/docker-keycloak-traefik-workshop#conclusion-keycloak-setup)
...
[final-demo-setup](https://github.com/ibuetler/docker-keycloak-traefik-workshop#final-demo-setup)
...
[![gk](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/gk.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/gk.png)
...
[keycloak-gatekeeper](https://github.com/ibuetler/docker-keycloak-traefik-workshop#keycloak-gatekeeper)
...
[create-new-client-in-keycloak](https://github.com/ibuetler/docker-keycloak-traefik-workshop#create-new-client-in-keycloak)
...
[![kc1](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc1.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc1.png)
Please give it a name and configure the client URL. For this tutorial `https://ttyd.idocker.hacking-lab.com`.

[![kc2](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc2.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc2.png)
Press choose "confidential" in the "Access Type" item and press "Save".

[![kc3](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc3.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc3.png)
...
[![kc4](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc4.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc4.png)
## Create Client Audience and Scope

[create-client-audience-and-scope](https://github.com/ibuetler/docker-keycloak-traefik-workshop#create-client-audience-and-scope)
...
[![kc5](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc5.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc5.png)

Give a Name and Description. I have chosen ttyd.

[![kc6](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc6.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc6.png)
Please click on "Mappers".

[![kc7](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc7.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc7.png)
...
[![kc8](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/audience.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/audience.png)
Last, you must apply the newly created mapper to your ttyd client configuration.

[![kc9](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc9.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc9.png)
...
[enable-user-self-registratio](https://github.com/ibuetler/docker-keycloak-traefik-workshop#enable-user-self-registration)

Please switch on "User registration" on the Master Realm Settings tab.

[![kc10](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc10.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc10.png)
## Testing User Self-Registration

[testing-user-self-registration](https://github.com/ibuetler/docker-keycloak-traefik-workshop#testing-user-self-registration)

Please start in Firefox a "New Private Window" and connect to the following URL

[https://auth.idocker.hacking-lab.com/auth/realms/master/account](https://auth.idocker.hacking-lab.com/auth/realms/master/account)

[![kc11](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc11.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc11.png)
Please register a new account

[![kc12](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc12.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc12.png)
Enter your data here

[![kc13](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc13.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc13.png)
...
[![kc14](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/kc14.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/kc14.png)
## Conclusion "Keycloak Client Configuration"

[conclusion-keycloak-client-configuration](https://github.com/ibuetler/docker-keycloak-traefik-workshop#conclusion-keycloak-client-configuration)
...
[![lion](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/ok.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/ok.png)
## Keycloak Gatekeeper

[keycloak-gatekeeper-1](https://github.com/ibuetler/docker-keycloak-traefik-workshop#keycloak-gatekeeper-1)
...
[![run1](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/run1.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/run1.png)
...
[configure-client-secret](https://github.com/ibuetler/docker-keycloak-traefik-workshop#configure-client-secret)
...
[![run2](https://github.com/ibuetler/docker-keycloak-traefik-workshop/raw/master/images/run2.png)](https://github.com/ibuetler/docker-keycloak-traefik-workshop/blob/master/images/run2.png)
...
[docker-compose](https://github.com/ibuetler/docker-keycloak-traefik-workshop#docker-compose)
